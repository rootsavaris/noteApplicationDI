package com.example.rafaelsavaris.noteapplicationdagger.data.source;
...
public class NotesRepository implements NotesDatasource {
    ...
    @Inject
    NotesRepository(@Remote NotesDatasource notesRemote, @Local NotesDatasource notesLocal) {
